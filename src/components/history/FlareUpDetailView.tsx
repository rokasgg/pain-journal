    ...
    <View className="gap-4">
      <View className="flex-row items-center justify-between">
        <Text className="text-xl font-bold text-black dark:text-white">
          {showDate ? formatCheckinDate(flareUp.occurred_at.slice(0, 10)) : 'Flare-up'}
        </Text>
      ...
      <View>
        <View className="flex-row items-center justify-between border-b border-gray-200 py-3 dark:border-gray-800">
          <Text className="text-sm text-gray-500 dark:text-gray-400">Pain level</Text>
          <Text className="text-base text-black dark:text-white">{flareUp.pain_level}</Text>
        </View>
        {flareUp.likely_cause && (
          <View className="flex-row items-center justify-between border-b border-gray-200 py-3 dark:border-gray-800">
            <Text className="text-sm text-gray-500 dark:text-gray-400">Likely cause</Text>
