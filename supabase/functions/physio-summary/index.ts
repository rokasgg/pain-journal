...
You will receive JSON with two arrays covering that window:
...
Overview — entry count, date range, general trend in pain/stiffness/range of motion over the period.
